...
class PipelineParallelResNet50(ModelParallelResNet50):
    ...
    def forward(self, x):
        ...
        # print("s_prev batch 0 device out of seq1 should be device 0: {}".format(s_prev.device))
        ...
        for s_next in splits:
            ...
            # print("s_prev batch 0 device out of seq2 should be device1: {}".format(s_prev.device))
